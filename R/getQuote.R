...
.yahooSession <- function(is.retry = FALSE) {
  ...
  if (is.null(ses) || is.retry) {
    ...
    curl::handle_setheaders(ses$h, 
                            ...
                            "User-Agent" = switch(Sys.info()["sysname"],
                                                  Linux="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.3",
                                                  Mac="Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36",
                                                  Windows="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36 Edg/115.0.1901.183"
                                                 )
                           )
